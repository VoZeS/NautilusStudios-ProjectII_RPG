...
void Combat_Manager::UpdateHUD()
{
	...
	app->render->DrawRectangle({ 75 + cx, 8 + cy, allies[0]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
	app->render->DrawRectangle({ 76 + cx, 9 + cy, allies[0]->GetActualHealth() / 2, 13 }, 255, 0, 0);
	app->render->DrawRectangle({ 76 + cx + allies[0]->GetActualHealth() / 2, 9 + cy, allies[0]->GetShield() / 2, 13 }, 120, 120, 120, 200);
	app->render->DrawRectangle({ 75 + cx, 8 + cy + 16, allies[0]->GetMaxMana() / 2, 15 }, 0, 0, 70);
	app->render->DrawRectangle({ 76 + cx, 9 + cy + 16, allies[0]->GetActualMana() / 2, 13 }, 0, 0, 255);
	...
	app->render->DrawRectangle({ 75 + cx, 8 + cy + 67, allies[1]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
	app->render->DrawRectangle({ 76 + cx, 9 + cy + 67, allies[1]->GetActualHealth() / 2, 13 }, 255, 0, 0);
	app->render->DrawRectangle({ 76 + cx + allies[1]->GetActualHealth() / 2, 9 + cy + 67, allies[1]->GetShield() / 2, 13 }, 120, 120, 120, 200);
	app->render->DrawRectangle({ 75 + cx, 8 + cy + 16 + 67, allies[1]->GetMaxMana() / 2, 15 }, 0, 0, 70);
	app->render->DrawRectangle({ 76 + cx, 9 + cy + 16 + 67, allies[1]->GetActualMana() / 2, 13 }, 0, 0, 255);
	...
	app->render->DrawRectangle({ 75 + cx + 250, 8 + cy, allies[2]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
	app->render->DrawRectangle({ 76 + cx + 250, 9 + cy, allies[2]->GetActualHealth() / 2, 13 }, 255, 0, 0);
	app->render->DrawRectangle({ 76 + cx + allies[2]->GetActualHealth() / 2 + 250, 9 + cy, allies[2]->GetShield() / 2, 13 }, 120, 120, 120, 200);
	app->render->DrawRectangle({ 75 + cx + 250, 8 + cy + 16, allies[2]->GetMaxMana() / 2, 15 }, 0, 0, 70);
	app->render->DrawRectangle({ 76 + cx + 250, 9 + cy + 16, allies[2]->GetActualMana() / 2, 13 }, 0, 0, 255);
	...
	app->render->DrawRectangle({ 75 + cx + 250, 8 + cy + 67, allies[3]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
	app->render->DrawRectangle({ 76 + cx + 250, 9 + cy + 67, allies[3]->GetActualHealth() / 2, 13 }, 255, 0, 0);
	app->render->DrawRectangle({ 76 + cx + allies[3]->GetActualHealth() / 2 + 250, 9 + cy + 67, allies[3]->GetShield() / 2, 13 }, 120, 120, 120, 200);
	app->render->DrawRectangle({ 75 + cx + 250, 8 + cy + 16 + 67, allies[3]->GetMaxMana() / 2, 15 }, 0, 0, 70);
	app->render->DrawRectangle({ 76 + cx + 250, 9 + cy + 16 + 67, allies[3]->GetActualMana() / 2, 13 }, 0, 0, 255);
	...
	if (enemies[0]->GetEntityState() != 2)
	{
		...
		app->render->DrawRectangle({ 75 + cx + 800, 8 + cy, enemies[0]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
		app->render->DrawRectangle({ 76 + cx + 800, 9 + cy, enemies[0]->GetActualHealth() / 2, 13 }, 255, 0, 0);
		app->render->DrawRectangle({ 76 + cx + enemies[0]->GetActualHealth() / 2 + 800, 9 + cy, enemies[0]->GetShield() / 2, 13 }, 120, 120, 120, 200);
		app->render->DrawRectangle({ 75 + cx + 800, 8 + cy + 16, enemies[0]->GetMaxMana() / 2, 15 }, 0, 0, 70);
		app->render->DrawRectangle({ 76 + cx + 800, 9 + cy + 16, enemies[0]->GetActualMana() / 2, 13 }, 0, 0, 255);
	...
	if (enemies[1]->GetEntityState() != 2)
	{
		...
		app->render->DrawRectangle({ 75 + cx + 800, 8 + cy + 67, enemies[1]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
		app->render->DrawRectangle({ 76 + cx + 800, 9 + cy + 67, enemies[1]->GetActualHealth() / 2, 13 }, 255, 0, 0);
		app->render->DrawRectangle({ 76 + cx + enemies[1]->GetActualHealth() / 2 + 800, 9 + cy + 67, enemies[1]->GetShield() / 2, 13 }, 120, 120, 120, 200);
		app->render->DrawRectangle({ 75 + cx + 800, 8 + cy + 16 + 67, enemies[1]->GetMaxMana() / 2, 15 }, 0, 0, 70);
		app->render->DrawRectangle({ 76 + cx + 800, 9 + cy + 16 + 67, enemies[1]->GetActualMana() / 2, 13 }, 0, 0, 255);
	...
	if (enemies[2]->GetEntityState() != 2)
	{
		...
		app->render->DrawRectangle({ 75 + cx + 250 + 800, 8 + cy, enemies[2]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
		app->render->DrawRectangle({ 76 + cx + 250 + 800, 9 + cy, enemies[2]->GetActualHealth() / 2, 13 }, 255, 0, 0);
		app->render->DrawRectangle({ 76 + cx + enemies[2]->GetActualHealth() / 2 + 250 + 800, 9 + cy, enemies[2]->GetShield() / 2, 13 }, 120, 120, 120, 200);
		app->render->DrawRectangle({ 75 + cx + 250 + 800, 8 + cy + 16, enemies[2]->GetMaxMana() / 2, 15 }, 0, 0, 70);
		app->render->DrawRectangle({ 76 + cx + 250 + 800, 9 + cy + 16, enemies[2]->GetActualMana() / 2, 13 }, 0, 0, 255);
	...
	if (enemies[3]->GetEntityState() != 2)
	{
		...
		app->render->DrawRectangle({ 75 + cx + 250 + 800, 8 + cy + 67, enemies[3]->GetMaxHealth() / 2, 15 }, 70, 0, 0);
		app->render->DrawRectangle({ 76 + cx + 250 + 800, 9 + cy + 67, enemies[3]->GetActualHealth() / 2, 13 }, 255, 0, 0);
		app->render->DrawRectangle({ 76 + cx + enemies[3]->GetActualHealth() / 2 + 250 + 800, 9 + cy + 67, enemies[3]->GetShield() / 2, 13 }, 120, 120, 120, 200);
		app->render->DrawRectangle({ 75 + cx + 250 + 800, 8 + cy + 16 + 67, enemies[3]->GetMaxMana() / 2, 15 }, 0, 0, 70);
		app->render->DrawRectangle({ 76 + cx + 250 + 800, 9 + cy + 16 + 67, enemies[3]->GetActualMana() / 2, 13 }, 0, 0, 255);
